...
c1 = convolution2dLayer([1 4], 64, 'stride', [1 4]); %Filter window size = [1 6], No of filters = 16, stride = [1 6].
...
c2 = convolution2dLayer([1 4], 32, 'stride', [1 4]); %Filter window size = [1 5], No of filters = 16, stride = [1 10].
r2 = reluLayer();
...
convnet_3 = [InputLayer; c1; r1; p1; c2; r2; p2; f1; s1; outputLayer]
