function resultsVector = SamClassification(hsiCube)
    ...
    class_ref_cubes = ["undefined_cube_Ref", "grass_cube_Ref",...
                "concrete_cube_Ref", "asphalt_cube_Ref",... 
                "tree_cube_Ref", "rocks_cube_Ref", "water_cube_Ref", ...
                "sky_cube_Ref", "gravel_cube_Ref", "objects_cube_Ref",...
                "person_cube_Ref", "dirt_cube_Ref", "mud_cube_Ref"];
